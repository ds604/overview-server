...
trait SearchIndexAndSearchStorage extends SearchHandlerComponents {

  override val storage: Storage = new SearchResultStorage
  ...
  class DocumentSearcherCreator extends ActorCreator {
    def produceDocumentSearcher(documentSetId: Long, query: String): Actor =
